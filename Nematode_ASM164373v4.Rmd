...
```{r}
line_survival <- read.csv(file = "~/My Drive/Nematode/Nematode_ASM164373v4_data/ANALYSES/extinction_all.csv")
...
```{r}
coverage <- read.table(file = "~/My Drive/Nematode/Nematode_ASM164373v4_data/ANALYSES/DP_range")[,c(1,2,4)]
...
callability <- read.table(file = "~/My Drive/Nematode/Nematode_ASM164373v4_data/ANALYSES/callability.txt", header = T)
...
```{r}
singleton_raw <- read.table(file = "~/My Drive/Nematode/Nematode_ASM164373v4_data/Manual_inspection/ANALYSES/singleton_raw")
...
VEP_input_blast <- read.table(file = "~/My Drive/Nematode/Nematode_ASM164373v4_data/VEP_input_blast.txt")
...
VEP_output <- read.table(file = "~/My Drive/Nematode/Nematode_ASM164373v4_data/VEP_output.txt")
...
# 
# VEP_analysis_IMPACT_temp <-
# aggregate(VEP_analysis_IMPACT$Number, by = list(VEP_analysis_IMPACT$Sample), 
#           FUN = sum)
# colnames(VEP_analysis_IMPACT_temp) <- c("Sample", "Total")
# 
# VEP_analysis_IMPACT <- merge(VEP_analysis_IMPACT, VEP_analysis_IMPACT_temp, 
#                                   by = "Sample", all = T)
# 
# VEP_analysis_IMPACT$perc <- 
# VEP_analysis_IMPACT$Number/VEP_analysis_IMPACT$Total
...
pdf(file = "/Users/rnt500/My Drive/Nematode/Nematode_ASM164373v4_MS/Nematode_MS_v6/Figure_1.pdf", width = 4, height = 4) # The size of the plot in inches
...
pdf(file = "/Users/rnt500/My Drive/Nematode/Nematode_ASM164373v4_MS/Nematode_MS_v6/Figure_2.pdf", width = 4, height = 4) # The size of the plot in inches
...
pdf(file = "/Users/rnt500/My Drive/Nematode/Nematode_ASM164373v4_MS/Nematode_MS_v6/Figure_3.pdf", width = 6, height = 4) # The size of the plot in inches
...
```{r}
pdf(file = "/Users/rnt500/My Drive/Nematode/Nematode_ASM164373v4_MS/Nematode_MS_v6/Figure_4.pdf", width = 8, height = 4) # The size of the plot in inches
...
pdf(file = "/Users/rnt500/My Drive/Nematode/Nematode_ASM164373v4_MS/Nematode_MS_v6/Figure_S2.pdf", width = 6, height = 4) # The size of the plot in inches
...
```{r}
pdf(file = "/Users/rnt500/My Drive/Nematode/Nematode_ASM164373v4_MS/Nematode_MS_v6/Figure_S5.pdf", width = 6, height = 12) # The size of the plot in inches
...
pdf(file = "/Users/rnt500/My Drive/Nematode/Nematode_ASM164373v4_MS/Nematode_MS_v6/Figure_S7.pdf", width = 6, height = 8) # The size of the plot in inches
...
TsTv_probabilistic_TsTv_df <- merge(temp, TsTv_probabilistic_TsTv, 
                  by.x = c("Sample", "TsTv"), by.y = c("Sample", "TsTv"), all = T)[,c(1,2,3,5,6)]
